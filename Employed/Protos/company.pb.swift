...
struct Employed_Io_Companies {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var companies: [Employed_Io_Company] = []
...
extension Employed_Io_Companies: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Companies"
  ...
  func _protobuf_generated_isEqualTo(other: Employed_Io_Companies) -> Bool {
    if self.companies != other.companies {return false}
...
extension Employed_Io_Company: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .same(proto: "headquarters"),
    8: .standard(proto: "founded_year"),
    9: .same(proto: "size"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularStringField(value: &_storage._about)
        case 5: try decoder.decodeSingularStringField(value: &_storage._avatarURL)
        case 6: try decoder.decodeSingularStringField(value: &_storage._website)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._headquarters)
        case 8: try decoder.decodeSingularInt32Field(value: &_storage._foundedYear)
        case 9: try decoder.decodeSingularInt32Field(value: &_storage._size)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._about.isEmpty {
        try visitor.visitSingularStringField(value: _storage._about, fieldNumber: 4)
      }
      ...
      if _storage._foundedYear != 0 {
        try visitor.visitSingularInt32Field(value: _storage._foundedYear, fieldNumber: 8)
      }
      if _storage._size != 0 {
        try visitor.visitSingularInt32Field(value: _storage._size, fieldNumber: 9)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
