...
extension Employed_Io_JobSeeker: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Employed_Io_JobSeeker) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._bio != other_storage._bio {return false}
        if _storage._avatarURL != other_storage._avatarURL {return false}
        if _storage._headline != other_storage._headline {return false}
        if _storage._currentPosition != other_storage._currentPosition {return false}
