...
extension Employed_Io_Location: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Employed_Io_Location) -> Bool {
...
extension Employed_Io_Address: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Employed_Io_Address) -> Bool {
    if self.streetAddress != other.streetAddress {return false}
    if self.city != other.city {return false}
    if self.state != other.state {return false}
    if self.country != other.country {return false}
    if self.zip != other.zip {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
}
