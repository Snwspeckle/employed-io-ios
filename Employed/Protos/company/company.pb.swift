...
struct Employed_Io_Company {
  ...
  mutating func clearHeadquarters() {_uniqueStorage()._headquarters = nil}
...
extension Employed_Io_Company: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Employed_Io_Company, rhs: Employed_Io_Company) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._headquarters != rhs_storage._headquarters {return false}
        if _storage._foundedYear != rhs_storage._foundedYear {return false}
