...
extension Employed_Io_LoginRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Employed_Io_LoginRequest, rhs: Employed_Io_LoginRequest) -> Bool {
...
extension Employed_Io_LoginResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Employed_Io_LoginResponse, rhs: Employed_Io_LoginResponse) -> Bool {
